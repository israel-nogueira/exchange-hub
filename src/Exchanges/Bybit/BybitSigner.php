...
/** Bybit v5: HMAC-SHA256. Signature covers timestamp+apiKey+recvWindow+params */
class BybitSigner
{
    ...
    {
        return ['X-BAPI-API-KEY'=>$this->apiKey,'X-BAPI-TIMESTAMP'=>$ts,'X-BAPI-SIGN'=>$sig,'X-BAPI-RECV-WINDOW'=>(string)$this->recvWindow,'Content-Type'=>'application/json'];
    }

    private function timestamp(): string { return (string)(int)(microtime(true)*1000); }
}
