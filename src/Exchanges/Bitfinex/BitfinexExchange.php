...
{
    private BitfinexSigner $signer; private BitfinexNormalizer $normalizer;
    protected function configure(): void { $this->name='bitfinex'; $this->baseUrl=BitfinexConfig::BASE_URL; $this->signer=new BitfinexSigner($this->apiKey,$this->apiSecret); $this->normalizer=new BitfinexNormalizer(); }

    public function ping(): bool { try{$this->http->get($this->baseUrl.'/api',[],'bitfinex');return true;}catch(\Exception $e){return false;} }
