...
{
    private MexcSigner $signer; private MexcNormalizer $normalizer;
    protected function configure(): void { $this->name='mexc'; $this->baseUrl=MexcConfig::BASE_URL; $this->signer=new MexcSigner($this->apiKey,$this->apiSecret); $this->normalizer=new MexcNormalizer(); }

    public function ping(): bool { try{$this->http->get($this->baseUrl.'/api',[],'mexc');return true;}catch(\Exception $e){return false;} }
