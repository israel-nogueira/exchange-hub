...
{{
    ...
    {{
        ...
        $r = $this->http->get($url, $hdrs, 'bitstamp');
    ...
    {{
        ...
        $r = $this->http->post($url, $body, $hdrs, 'bitstamp');
        return $r['data'] ?? $r['result'] ?? $r;
    }}

    public function ping(): bool
    {{
        try {{ $this->http->get($this->baseUrl, [], 'bitstamp'); return true; }}
    ...
    public function getAccountInfo(): array {{ return $this->apiGet('/balance/', [], true); }}
    ...
    public function createOrder(string $symbol, string $side, string $type, float $quantity, ?float $price = null, ?float $stopPrice = null, ?string $timeInForce = 'GTC', ?string $clientOrderId = null): OrderDTO {{ throw new \RuntimeException('Bitstamp: createOrder not yet implemented'); }}
    public function cancelOrder(string $symbol, string $orderId): OrderDTO {{ throw new \RuntimeException('Bitstamp: cancelOrder not yet implemented'); }}
    ...
    public function editOrder(string $symbol, string $orderId, ?float $price = null, ?float $quantity = null): OrderDTO {{ throw new \RuntimeException('Bitstamp: editOrder not yet implemented'); }}
