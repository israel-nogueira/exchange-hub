...
{
    private GeminiSigner $signer; private GeminiNormalizer $normalizer;
    protected function configure(): void { $this->name='gemini'; $this->baseUrl=GeminiConfig::BASE_URL; $this->signer=new GeminiSigner($this->apiKey,$this->apiSecret); $this->normalizer=new GeminiNormalizer(); }

    public function ping(): bool { try{$this->http->get($this->baseUrl.'/api',[],'gemini');return true;}catch(\Exception $e){return false;} }
