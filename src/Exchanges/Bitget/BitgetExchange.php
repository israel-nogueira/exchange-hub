...
{
    private BitgetSigner $signer; private BitgetNormalizer $normalizer;
    protected function configure(): void { $this->name='bitget'; $this->baseUrl=BitgetConfig::BASE_URL; $this->signer=new BitgetSigner($this->apiKey,$this->apiSecret,$this->passphrase); $this->normalizer=new BitgetNormalizer(); }

    public function ping(): bool { try{$this->http->get($this->baseUrl.'/api',[],'bitget');return true;}catch(\Exception $e){return false;} }
